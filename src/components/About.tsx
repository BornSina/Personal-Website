...
const About = () => {
  let traits: traitsObj = {
    Strategic: {
      ...
      font: "500 1.65rem IBM Plex Mono !important",
    },
    Leader: {
      color: "rgb(173,55,239)",
      content: "I am a leader",
      font: "500 2.25rem Playfair Display !important",
    },
    Creative: {
      color: "rgb(0,250,154)",
      content: "I am creative",
      font: "400 1.65rem Merienda !important",
    },
    Ambitious: {
      color: "rgb(255, 191, 0)",
      content: "I am ambitious",
      font: "400 1.45rem Alfa Slab One !important",
    },
    Passionate: {
      color: "rgb(255,114,80)",
      content: "I am passionate",
      font: "400 2.25rem Great Vibes !important",
    },
    Collaborative: {
      color: "rgb(255,110,175)",
      content: "I am collaborative",
      font: "400 1.7rem Open Sans !important",
    },
  };
